#!/bin/bash
# Script to start all Daria services with LangChain enabled for analysis functionality

echo "===== DARIA SERVICES WITH ANALYSIS FUNCTIONALITY ====="
...
# Now start the main interview API with LangChain enabled (for analysis)
echo "Starting Main Interview API on port 5025 (with LangChain for analysis)..."
...
echo ""
echo "Analysis is now enabled with LangChain support."
